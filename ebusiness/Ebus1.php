...
<html>
       ...
       * {
           ...
           /* Below is the Same Div Design used in the CV Page for Consistency */
           ...
           /* And the Same Internal CSS for the two lines either side of the H1 Headings */
           h1 {
               position: relative;
               font-size: 30px;
               z-index: 1;
           ...
           h1:before {
               ...
               text-align: right;
                           ...
                           /* This is the Header for the Div which differs in Border Style */
                           #divHeader {
                            width: 600px;
                            border-color: black;
                            border-style: inset;
